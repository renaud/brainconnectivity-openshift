...
vocab_file = 'data/20140522_brainer_entities_idx_2.tsv' #20140509_brainer_entities_idx.tsv'
...
def getMySQLConnection():
    #return pymysql.connect(host="128.178.187.160", user="protconc", passwd="nfws332dccmyn10cq", db="20140226_coocs", charset='utf8');
    return pymysql.connect(host="localhost", user="root", passwd="", db="20140226_coocs", charset='utf8');
...
if __name__ == "__main__":
    ...
    print 'server (re)started, go visit http://localhost:%s' % port
